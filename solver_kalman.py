...
class SolverFilterPlan:
    def __init__(self,kfilter,q0,q1,r0,r1,normal,newset,start=np.array([1,0,0,0],dtype=mpf),gravity=np.array([0,0,1],dtype=mpf),proj_fun=None,size=100):
        """
        Parameters
        ----------
        kfilter : TYPE
        ...
        self.KFilter = kfilter(dt, QQ,RR,PK, X,Quat, bias, normal,mag0=mag0,rotsurf=self.rotsurf,proj_fun=proj_fun,time=time0,base_width=base_width)
